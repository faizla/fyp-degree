...
LineChart.prototype.wrangleData = function(){
    ...
    vis.dataFiltered=vis.dataFiltered.map(function(d){
            return{date:d.date, positive:d[1], negative:d[0]}
        })
...
LineChart.prototype.dummyDate = function(){
    var vis = this;
    ...
    for(var i=2; i <= Difference_In_Days ; i++){
        ...
        {               
            ...
            vis.dataFiltered=vis.dataFiltered.concat([{date:formatTime(date1.setDate(date1.getDate())),positive:0,negative:0}])
...
LineChart.prototype.updateVis = function(){
    ...
    vis.dataFiltered=vis.dataFiltered.concat([{date:formatTime(dMin.setDate(dMin.getDate()-1)),positive:0,negative:0}])
    ...
    vis.pathPositive.data([vis.dataFiltered])
        .attr('fill', 'none')
        .attr('stroke', vis.color("1") )
        .attr('stroke-width', '2')
        .attr('d', vis.linePositive);
    vis.pathNegative.data([vis.dataFiltered])
        .attr('fill', 'none')
